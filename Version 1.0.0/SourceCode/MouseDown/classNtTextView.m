...
//  GreekBibleStudent
//
//  Created by Leonard Clark on 07/01/2021.
//

#import "classNtTextView.h"

@implementation classNtTextView
...
- (void) mouseDown:(NSEvent *)event
{
    ...
    mainAppDelegate = (AppDelegate *)[[NSApplication sharedApplication] delegate];
    sourceView = [mainAppDelegate ntTextView];
    ...
    [mainAppDelegate locateCurrentTextView:1 forTextView:1];
    [mainAppDelegate mouseDownCursorRecord:cursorPosition targetCode:1 inVerse:verseString containingLineRange:lineRange withRevisedCursorPosition:lineCsrPstn
